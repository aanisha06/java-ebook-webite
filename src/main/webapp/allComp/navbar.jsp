...
<div class="form-search">
		<form class="form-serach" action="srch" method="post">
    ...
    %>
     <div style="justify-content: center;" class="story-ebook">
        <div class="story-image">
            ...
            if(u==null){
            %>
            <button type="submit" onclick="window.location.href='signin.jsp';" class="card-btn">add to library</button>
            <%}
            else{
            %>
            <button type="submit"  onclick="window.location.href='libservlet';" class="card-btn">add to library</button>
            <%
            }
            %>
        </div>
