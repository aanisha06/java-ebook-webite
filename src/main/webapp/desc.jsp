...
%>	
  ...
  <div class="write chapter-name" >
         <img style="height:300px;width:260px" src="pictures/<%=titleO.getPhotoname()%>">
      </div><br> <br>
 <div class="write read" >
         <a  href="flipstories.jsp?titleid=<%=titleO.getTitleId()%>"><b>Read</b></a>
         <div class="write addtolib" >
         <a  href="flipstories.jsp?titleid=<%=titleO.getTitleId()%>"><b>Add to Library</b></a>
      </div><br> <br>
      </div><br> <br>
 ...
 <div class="write title-name" >
      ...
      <% 
	String cont=titleO.getDescription(); 
%> 
